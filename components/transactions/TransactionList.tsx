...
> {
  ...
  static getDerivedStateFromProps = (
    nextProps: TransactionListProps,
...
const mapStateToProps = (
  state: AppState,
  ownProps: { userId: string; navigationCallback: any }
): StateProps => {
  let transactions = state.transactionReducer.filter(
    (transaction: Transaction) => {
      return transaction.lenderId === ownProps.userId;
    }
  );
