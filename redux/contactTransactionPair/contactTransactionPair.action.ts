import {
  ...
  ADD_MULTIPLE_TRANSACTION_PAIRS,
...
export const addContactToTransaction = (
  contact: Contact,
...
export const addMultipleContactTransactionPairs = (
...
export const removeContactFromTransaction = (
  contactId: string
): AppActions => ({
...
export const removeContactsByTransactionId = (
