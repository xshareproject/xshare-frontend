...
export const REMOVE_CONTACT_FROM_TRANSACTION =
  "REMOVE_CONTACT_FROM_TRANSACTION";
export const REMOVE_CONTACTS_BY_TRANSACTION_ID =
  "REMOVE_CONTACTS_BY_TRANSACTION_ID";
...
export type ContactTransactionPairActionTypes =
  | loadContactTransactionPairsAction
  | addContactToTransactionAction
  | addContactsByTransactionIdAction
  | addMultipleTransactionPairs
  | removeContactFromTransactionAction
  | removeContactsByTransactionIdAction
  | editAmountAction;
...
export type ContactActionTypes =
  | loadContactsAction
  | readAllContactsAction
  | createContactAction
  | updateContactAction
  | updateContactByPropertyAction
  | deleteContactAction
  | removeContactsByTransactionIdAction;
...
export type TransactionActionTypes =
  ...
  | updateTransactionByPropertyAction;

//Add more as we expand our redux
export type AppActions =
  | ContactTransactionPairActionTypes
