...
> {
  ...
  render() {
    let displaySaveOverlay = (
      <Overlay
        isVisible={this.state.displaySavePrompt}
      ...
      >
        <View>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            <Button title="Cancel" onPress={() => this.cancelChanges()} />
          </View>
        </View>
      </Overlay>
    );
      ...
      <React.Fragment>
        ...
        <View style={styles.topBar}>
          ...
          >
            <Text style={{ textAlign: "center" }}>
              Created by you on {this.state.editedTransaction.createdDate}{" "}
            </Text>
            <Icon
              name="pencil"
              type="entypo"
          ...
          >
            ...
            <Text style={{ fontSize: 20, textAlign: "center" }}>
              {this.state.editedTransaction.transactionName}
            </Text>
          </View>
        </View>
        ...
        <RNPickerSelect
          ...
          items={[
            ...
            {
              label: "Recurring Transcation",
              value: TRANSACTION_TYPE.RECURRING,
            },
          ]}
          onValueChange={(value) => {
            if (value !== null)
        ...
        <ScrollView style={styles.container}>
          ...
          >
            <FieldInputWithLabel
              currentTransaction={this.state.editedTransaction}
              propertyName="paymentDate"
              label="PAYMENT DEADLINE"
              editable={this.state.editable}
              updateEditedTransaction={this.updateEditedTransaction}
            />
            <FieldInputWithLabel
              currentTransaction={this.state.editedTransaction}
              propertyName="note"
            ...
            <Text
              style={
                this.state.transactionType === TRANSACTION_TYPE.MEAL
                  ? null
                  : { display: "none" }
              }
            >
            ...
            <Button
              ...
              containerStyle={
                this.state.transactionType === TRANSACTION_TYPE.RECURRING
                  ? null
                  : { display: "none" }
              }
            />
    ...
    return (
      <View>
        ...
        <Text
          style={styling}
          onPress={() => {
            if (props.editable) setDisplayDatePicker(true);
          }}
        >
...
function RecurrencePicker() {
  ...
  const [recurrenceInstance, setRecurrenceInstance] = React.useState(
    weekday[0]
  );
  ...
  let recurrenceTypePicker = (
    <Picker
      style={{ width: 120, height: 30, fontSize: bodyText }}
      selectedValue={recurrenceType}
      onValueChange={(itemValue) => {
        setRecurrenceType(itemValue.toString());
      }}
      prompt="Recurrence Type"
    >
  ...
  let recurrenceDistanceInput = (
    <TextInput
      ...
      onEndEditing={(event) => {
        setRecurrenceDistance(toInteger(event.nativeEvent.text));
      }}
  ...
  let weeklySelector = (
    <Picker
      selectedValue={recurrenceInstance}
      onValueChange={(itemValue) => {
        setRecurrenceType(itemValue.toString());
      }}
      style={pickerStyling}
    >
      {weekday.map((instance) => {
        return <Picker.Item label={instance} value={instance} />;
      })}
    </Picker>
  );
  ...
  //month with 31 days
  if (
    monthInstance == months[0] ||
    monthInstance == months[2] ||
    monthInstance == months[4] ||
    monthInstance == months[6] ||
    monthInstance == months[7] ||
    monthInstance == months[9] ||
    monthInstance == months[11]
  ) {
  ...
  let yearlySelector = (
    <View style={{ flexDirection: "row", height: 50 }}>
      <Picker
        ...
        style={{ flex: 0.5 }}
      >
        {date.slice(0, monthEndInstance).map((instance) => {
          return <Picker.Item label={instance} value={instance} />;
        })}
      </Picker>
      <Picker
        selectedValue={monthInstance}
        onValueChange={(itemValue) => {
          setMonthInstance(itemValue.toString());
        }}
        style={{ flex: 0.5 }}
      >
        {months.map((instance) => {
